...
import com.nithi.restapi.repository.PostRepository;
import com.nithi.restapi.repository.UserRepository;
...
public class UserResourceJpa {
	...
	public List<Post> retriveUserAllPost(@PathVariable int id) {
